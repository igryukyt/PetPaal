...
<head>
    ...
    <meta name="description" content="PetPal - Your trusted companion for pet care, accessories, and veterinary connections">
...
<body>
    ...
    <section class="hero">
        <div class="floating-paws">
            <?php for ($i = 0; $i < 10; $i++): ?>
                <span class="paw" style="left: <?php echo rand(0, 100); ?>%; animation-delay: <?php echo rand(0, 15); ?>s;">🐾</span>
            <?php endfor; ?>
        </div>
                ...
                <?php foreach ($products as $product): ?>
                    <div class="product-card">
                        <div class="product-image-wrapper">
                            <img src="<?php echo h($product['image_url']); ?>" 
            ...
            <div class="gallery-grid">
                <?php foreach ($photos as $photo): ?>
                    <div class="gallery-item">
                        <img src="<?php echo h($photo['photo_url']); ?>" 
                             alt="<?php echo h($photo['pet_name']); ?>"
                             loading="lazy">
